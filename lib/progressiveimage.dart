...
class ProgressiveImageExample extends StatelessWidget {
  ...
  Widget get example1 => ProgressiveImage(
    ...
    image: NetworkImage('https://www.enzolifesciences.com/fileadmin/redacteur/bilder/landing_pages'
        '/TechNotes/2019/2019-12-20-fluorescence-phosphorescence-luminescence.jpg'), // 3842x2160
    height: 250,
    width: 500,
    fit: BoxFit.cover,
  );
