    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: Column(
          ...
          children: [
            // {
            //   Sizer.h(context), Sizer.w(context), Sizer.devicePixelRatio(context), Sizer.aspectRatio(context), Sizer.orientation(context), Sizer.isPortrait(context), Sizer.isLandscape(context), Sizer.screenSize(context), Sizer.isMobile(context), Sizer.isTablet(context), Sizer.isDesktop(context):
            //   These are all methods provided by the mediaquery_sizer package.
            //   They are used to get information about the device's screen, such as height, width, device pixel ratio
